...
var csv2jsonCmd = &cobra.Command{
	Use:   "csv2json",
	Short: "converts csv file to json",
	Long: `This utility parses a csv (comma or semicolon) delimited file
	and converts it into json file`,
	Run: func(cmd *cobra.Command, args []string) {
		fmt.Println("csv2json called")
	},
}
...
func getFileData() (inputFile, error) {
	...
	pretty := flag.Bool("pretty", true, "Generate pretty JSON")
	...
	if !(*separator == "comma" || *separator == "semicolon") {
		return inputFile{}, errors.New("only comma or semicolon allowed as separator")
	}
